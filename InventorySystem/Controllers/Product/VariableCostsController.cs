...
namespace InventorySystem.Controllers
{
    ...
    public class VariableCostsController : Controller
    {
        ...
        {
            return Ok(
                new ProductVariableCostsDataLayer(_configuration)
                    .InsertProductVariableCost(productsVariableCostInsert));
        }
        ...
        public IActionResult Put([FromBody] ProductsVariableCostUpdate productsVariableCostUpdate)
        {
            return Ok(
                new ProductVariableCostsDataLayer(_configuration)
                    .UpdateProductVariableCost(productsVariableCostUpdate));
        }
        ...
        public IActionResult Delete([FromBody] ProductsVariableCostDelete productsVariableCostDelete)
        {
            return Ok(
                new ProductVariableCostsDataLayer(_configuration)
                    .DeleteProductVariableCost(productsVariableCostDelete));
        }
    }
}